...
describe('FLAG ROUTER', () => {
  ...
  test('POST to /flags should return 400 for bad url (no wikipedia)', () => {
  ...
  test('POST to /flags should return 400 for bad url (wrong format)', () => {
